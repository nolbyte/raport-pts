...
$sql2 = $db->prepare("SELECT * FROM rp_ipa WHERE ipa_id = :idna");
$sql2->execute(array(':idna' => $_SESSION['idSiswa']));
$rpt = $sql2->fetch(PDO::FETCH_ASSOC);
$token = urlencode(encryptor('encrypt', $rpt['ipa_id']));
?>
<!DOCTYPE html>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h4 class="box-title"><?= $rpt['ipa_nama']?></h4>
                                ...
                                <div class="box-body">
                                    ...
                                    <a target="_blank" href="../cetak/RaportIPA.php?tingal=<?=$token;?>" class="btn btn-success"><i class="fa fa-print"></i> Cetak Hasil UHB</a>
                                </div>
                            </div>
                        </div>
                    </div>
